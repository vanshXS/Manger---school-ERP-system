package com.vansh.manger.Manger.timetable.service;
...
public class TimeTableService {
    ...
    public TimeTableResponseDTO mapToResponse(TimeTable timeTable) {
        ...
        return TimeTableResponseDTO.builder()
                ...
                .classroomName(timeTable.getTeacherAssignment().getClassroom().getGradeLevel() + " " + timeTable.getTeacherAssignment().getClassroom().getSection())
